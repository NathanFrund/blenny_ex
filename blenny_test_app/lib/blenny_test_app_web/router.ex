defmodule BlennyTestAppWeb.Router do
  ...
  # scope "/api", BlennyTestAppWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:blenny_test_app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BlennyTestAppWeb.Telemetry
