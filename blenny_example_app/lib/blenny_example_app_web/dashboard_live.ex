defmodule BlennyExampleAppWeb.DashboardLive do
  use BlennyExampleAppWeb, :live_view
  ...
  defp format_time(%{"timestamp" => ts}) when is_integer(ts) do
    BlennyExampleApp.Time.from_unix_ms(ts)
  end

  defp format_time(_), do: BlennyExampleApp.Time.format_timestamp()

  defp format_timestamp do
    BlennyExampleApp.Time.format_timestamp()
  end
