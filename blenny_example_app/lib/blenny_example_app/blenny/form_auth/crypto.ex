defmodule BlennyExampleApp.Blenny.FormAuth.Crypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> hash = BlennyExampleApp.Blenny.FormAuth.Crypto.derive_key("password", "salt")
      iex> String.match?(hash, ~r/^[0-9a-f]{64}$/)
      true

      iex> BlennyExampleApp.Blenny.FormAuth.Crypto.derive_key("same", "salt") ==
      ...> BlennyExampleApp.Blenny.FormAuth.Crypto.derive_key("same", "salt")
      true

      iex> BlennyExampleApp.Blenny.FormAuth.Crypto.derive_key("diff", "salt") !=
      ...> BlennyExampleApp.Blenny.FormAuth.Crypto.derive_key("same", "salt")
      true
  """
