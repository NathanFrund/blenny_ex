...
config :blenny_example_app, BlennyExampleAppWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:blenny_example_app, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:blenny_example_app, ~w(--watch)]}
  ]
...
config :blenny_example_app, dev_routes: true
